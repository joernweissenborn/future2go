...
func TestFutureChainCompletion(t *testing.T){
	...
	c := make(chan interface {})
	defer close(c)
	f.Then(func(d interface{})interface {}{return d}).Then(testcompleter(c))
...
func testcompleter(c chan interface {}) CompletionFunc {
...
func testcompletererr(c chan error) ErrFunc{
...
func testcompletererrwitherr(c chan error) ErrFunc{
	return func(e error) (interface{}, error){
		c<-e
